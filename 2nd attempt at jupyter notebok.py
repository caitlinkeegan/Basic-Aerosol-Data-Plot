...
copy_d_df['CO2'] = pd.to_numeric(copy_d_df['CO2'], errors = 'coerce')
...
copy_e_df[['DATE', 'CO2']].set_index('DATE').plot(figsize=(15,8))  #uncommented when above is commented out  #doesn't reach this
# In[]:
